...
export default function PizzaCard({ pizza, onAddToCart }) {
	return (
		<div className="flex gap-5 items-center rounded-md p-4 w-full mx-6 shadow-xl bg-gray-50 border-2 border-gray-100 sm:mx-14 lg:w-[23rem] lg:flex-grow lg:mx-16 2xl:max-w-[27rem] lg:hover:scale-105 lg:transition-all">
